<%-- 
    Document   : contact
    Created on : 2 may. 2023, 20:54:09
    Author     : AMD RYZEN 7
--%>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="inner-content">
                            <h2>Contactanos</h2>
                            <span>Joyas que te haran brillar</span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="contact-us">
            <div class="container">
                <div class="row">
                    <div class="col-lg-6">
                        <div id="map">
                            <img class="img-fluid"style="width: 500px; height: 300px;"src="assets/images/contacto1.jpg" alt="">
                    ...
                    <div class="col-lg-6">
                        <div class="section-heading">
                            ...
                            <span>¡Puedes contactarnos y enviarnos tus comentarios!</span>
                        </div>
                        <form id="contact" action="" method="post">
                            <div class="row">
                                <div class="col-lg-6">
                                    <fieldset>
                                        <input name="name" type="text" id="name" placeholder="Tú nombre" required="">
                                    </fieldset>
                                </div>
                                <div class="col-lg-6">
                                    <fieldset>
                                        <input name="email" type="text" id="email" placeholder="Tú correo" required="">
                                    </fieldset>
                                </div>
                                <div class="col-lg-12">
                                    <fieldset>
                                        <textarea name="message" rows="6" id="message" placeholder="Tú mensaje" required=""></textarea>
                                    </fieldset>
                                </div>
                                <div class="col-lg-12">
                                    <fieldset>
